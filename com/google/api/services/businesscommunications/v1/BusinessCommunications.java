...
public class BusinessCommunications extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Brands {
    ...
    public class Agents {
       ...
       * <pre>
       *   {@code BusinessCommunications businesscommunications = new BusinessCommunications(...);}
       *   {@code BusinessCommunications.Greetings.List request = businesscommunications.greetings().list(parameters ...)}
       * </pre>
       *
       * @return the resource collection
       */
      ...
      public class Greetings {
         ...
         *
         * Create a request for the method "greetings.create".
         *
         * This request holds the parameters needed by the businesscommunications server.  After setting any
         * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The unique identifier of the agent associated with the greeting. If the brand ID is "1234"
         *        and the agent ID is "5678", this parameter resolves to "brands/1234/agents/5678".
         * @param content the {@link com.google.api.services.businesscommunications.v1.model.Greeting}
         * @return the request
         */
        public Create create(java.lang.String parent, com.google.api.services.businesscommunications.v1.model.Greeting content) throws java.io.IOException {
          Create result = new Create(parent, content);
          initialize(result);
          return result;
        }

        public class Create extends BusinessCommunicationsRequest<com.google.api.services.businesscommunications.v1.model.Greeting> {

          private static final String REST_PATH = "v1/{+parent}/greetings";
         ...
         *        and the agent ID is "5678", this parameter resolves to "brands/1234/agents/5678".
           ...
           * @since 1.13
           */
          protected Create(java.lang.String parent, com.google.api.services.businesscommunications.v1.model.Greeting content) {
            super(BusinessCommunications.this, "POST", REST_PATH, content, com.google.api.services.businesscommunications.v1.model.Greeting.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * Required. The unique identifier of the agent associated with the greeting. If the brand
           * ID is "1234" and the agent ID is "5678", this parameter resolves to
           * "brands/1234/agents/5678".
           */
          @com.google.api.client.util.Key
          private java.lang.String parent;

          /** Required. The unique identifier of the agent associated with the greeting. If the brand ID is
         "1234" and the agent ID is "5678", this parameter resolves to "brands/1234/agents/5678".
           */
          public java.lang.String getParent() {
            return parent;
          }
         ...
         *
         * Create a request for the method "greetings.get".
         *
         * This request holds the parameters needed by the businesscommunications server.  After setting any
         * optional parameters, call the {@link Get#execute()} method to invoke the remote operation.
         *
         * @param name Required. The unique identifier of the greeting. If the brand ID is "1234", agent ID is "5678", and
         *        greeting ID is "abcd", this parameter resolves to
         *        "brands/1234/agents/5678/greetings/abcd".
         * @return the request
         */
        public Get get(java.lang.String name) throws java.io.IOException {
          Get result = new Get(name);
        ...
        public class Get extends BusinessCommunicationsRequest<com.google.api.services.businesscommunications.v1.model.Greeting> {

          private static final String REST_PATH = "v1/{+name}";

          private final java.util.regex.Pattern NAME_PATTERN =
              java.util.regex.Pattern.compile("^brands/[^/]+/agents/[^/]+/greetings/[^/]+$");
         ...
         *        "brands/1234/agents/5678/greetings/abcd".
           ...
           */
          protected Get(java.lang.String name) {
            super(BusinessCommunications.this, "GET", REST_PATH, null, com.google.api.services.businesscommunications.v1.model.Greeting.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
                  "^brands/[^/]+/agents/[^/]+/greetings/[^/]+$");
            }
          }
          ...
          /**
           * Required. The unique identifier of the greeting. If the brand ID is "1234", agent ID is
           * "5678", and greeting ID is "abcd", this parameter resolves to
           * "brands/1234/agents/5678/greetings/abcd".
           */
          @com.google.api.client.util.Key
          private java.lang.String name;

          /** Required. The unique identifier of the greeting. If the brand ID is "1234", agent ID is "5678", and
         greeting ID is "abcd", this parameter resolves to "brands/1234/agents/5678/greetings/abcd".
           */
          public java.lang.String getName() {
            return name;
          }
         ...
         *
         * Create a request for the method "greetings.list".
         *
         * This request holds the parameters needed by the businesscommunications server.  After setting any
         * optional parameters, call the {@link List#execute()} method to invoke the remote operation.
         *
         * @param parent Required. The unique identifier of the agent. If the brand ID is "1234" and agent ID is "5678", this
        ...
        public class List extends BusinessCommunicationsRequest<com.google.api.services.businesscommunications.v1.model.ListGreetingsResponse> {
          ...
          /**
           * Lists all greetings associated with an agent. *Note*: This method always sets `pageSize` to
           * `0`.
           *
           * Create a request for the method "greetings.list".
           *
         ...
         *        parameter resolves to "brands/1234/agents/5678".
           ...
           */
          protected List(java.lang.String parent) {
            super(BusinessCommunications.this, "GET", REST_PATH, null, com.google.api.services.businesscommunications.v1.model.ListGreetingsResponse.class);
            this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                  "Parameter parent must conform to the pattern " +
          ...
          /**
           * Required. The unique identifier of the agent. If the brand ID is "1234" and agent ID is
           * "5678", this parameter resolves to "brands/1234/agents/5678".
           */
          @com.google.api.client.util.Key
          private java.lang.String parent;

          /** Required. The unique identifier of the agent. If the brand ID is "1234" and agent ID is "5678",
         this parameter resolves to "brands/1234/agents/5678".
           */
          public java.lang.String getParent() {
            return parent;
          }
          ...
          /**
           * Specify the maximum number of results for the server to return. The server may limit
           * the number of results returned per page. If the page_size is 0, the server will decide
           * how many results to return.
           */
          @com.google.api.client.util.Key
          private java.lang.Integer pageSize;

          /** Specify the maximum number of results for the server to return. The server may limit the number of
         results returned per page. If the page_size is 0, the server will decide how many results to
         return.
           */
          public java.lang.Integer getPageSize() {
            return pageSize;
        ...
        /**
         * Updates the information about a greeting. *Caution*: If you update a field that takes a list as
         * input, you must include the entire list in the update request. Updates to list fields replace the
         * entire list.
         *
         * Create a request for the method "greetings.patch".
         *
         * This request holds the parameters needed by the businesscommunications server.  After setting any
         * optional parameters, call the {@link Patch#execute()} method to invoke the remote operation.
         *
         * @param name Output only. The name of the greeting, as set by Business Messages. Resolves to
         *        "brands/{brand_id}/agents/{agent_id}/greetings/{greeting_id}" where {greeting_id} is the
         *        unique ID of the greeting.
         * @param content the {@link com.google.api.services.businesscommunications.v1.model.Greeting}
         * @return the request
         */
        public Patch patch(java.lang.String name, com.google.api.services.businesscommunications.v1.model.Greeting content) throws java.io.IOException {
          Patch result = new Patch(name, content);
          initialize(result);
          return result;
        }

        public class Patch extends BusinessCommunicationsRequest<com.google.api.services.businesscommunications.v1.model.Greeting> {
         ...
         *        unique ID of the greeting.
           ...
           * @since 1.13
           */
          protected Patch(java.lang.String name, com.google.api.services.businesscommunications.v1.model.Greeting content) {
            super(BusinessCommunications.this, "PATCH", REST_PATH, content, com.google.api.services.businesscommunications.v1.model.Greeting.class);
            this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                  "Parameter name must conform to the pattern " +
           ...
           * "brands/{brand_id}/agents/{agent_id}/greetings/{greeting_id}" where {greeting_id} is
           * the unique ID of the greeting.
           */
          @com.google.api.client.util.Key
          private java.lang.String name;

          /** Output only. The name of the greeting, as set by Business Messages. Resolves to
         "brands/{brand_id}/agents/{agent_id}/greetings/{greeting_id}" where {greeting_id} is the unique ID
         of the greeting.
           */
          public java.lang.String getName() {
            return name;
