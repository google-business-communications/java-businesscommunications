...
public class BusinessCommunications extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Brands {
     ...
     * Deletes a brand.
     *
     * If the brand has any associated agents or locations, the delete request fails unless `force` is
     * `true`.
     *
     ...
     *
     * @param name Required. The unique identifier of the brand. If the brand identifier is "1234", this
    parameter
     ...
     *
     * @param name Output only. The unique identifier of the brand.
    ...
    public class Agents {
       ...
       * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param parent Required. The unique identifier of the brand the agent represents. If the brand
      identifier is
       ...
       * Deletes an agent.
       *
       * The delete request fails if any `brands.agents.requestVerification` requests have been made for
       * the agent.
       *
       ...
       * optional parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       * @param name Required. The unique identifier of the agent. If the brand identifier is "1234" and
      the agent
       *        identifier is "5678", this parameter resolves to
      "brands/1234/agents/5668".
       * @return the request
       */
      public Delete delete(java.lang.String name) throws java.io.IOException {
        Delete result = new Delete(name);
       ...
       * optional parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
       * @param parent Required. The unique identifier of the brand. If the brand identifier is "1234", this
      parameter
       *        resolves to "brands/1234".
       * @return the request
       */
       ...
       * operation.
       *
       * @param name Required. The unique identifier of the agent. If the brand identifier is "1234"
      and the agent
       *        identifier is "5678", this parameter resolves to
    ...
    public class Locations {
       ...
       * optional parameters, call the {@link Create#execute()} method to invoke the remote operation.
       *
       * @param parent Required. The unique identifier of the brand associated with the location. If the
      brand identifier
       ...
       * Deletes a location.
       *
       * The delete request fails if any `brands.locations.requestVerification` requests have been made
       * for the location.
       *
       ...
       * optional parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       * @param name Required. The unique identifier of the location. If the brand identifier is "1234"
      and the location
       *        identifier is "5678", this parameter resolves to
       ...
       * optional parameters, call the {@link Patch#execute()} method to invoke the remote operation.
       *
       * @param name The unique identifier of the location.
      Read-only. Defined by the platform.
       * @param content the {@link com.google.api.services.businesscommunications.v1.model.Location}
       * @return the request
       */
