...
public final class Location extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The name of the agent associated with the location. If the brand identifier is "1234" and the
  ...
  /**
   * Required. List of entry point configurations for locations.
   *
   ...
   * used in Google Maps, for the location.
   *
   * Not modifiable after being available to users through an agent.
   * The value may be {@code null}.
   */
