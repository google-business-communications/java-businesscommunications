 ...
 * unavailable during those gaps. Bot hours have no effect on availability. Bot-only agents always
 * display a welcome message, while agents with both human and bot representative settings only
 * consider human representatives when defining availability.
 *
